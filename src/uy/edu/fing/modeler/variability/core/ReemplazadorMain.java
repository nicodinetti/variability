...
public class ReemplazadorMain {
    ...
    public static void main(String[] args) throws Exception {
        try {
            ...
            /*
             * selectedVariants.put(basePath + "/compra.bpmn/Pagar", "PagarConCredito/PagarConCredito.bpmn"); selectedVariants.put(basePath +
             * "/varPoint(Pagar)/PagarConCredito/PagarConCredito.bpmn/ProcesoDePago", "AmericanExpress/AmericanExpress.bpmn"); selectedVariants.put(basePath +
             * "/varPoint(Pagar)/PagarConCredito/varPoint(ProcesoDePago)/AmericanExpress/AmericanExpress.bpmn/Pais", "Uruguay.bpmn");
             */
